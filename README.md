...
Stay on **DEMO** for partner showings. `/interface` opens the flagship case (Reconnaissance drone): picture, ATTENTION, ranked advice, and a short cue. Take the recommended action — a designated ACK appears on Watch Comms. Press **Pilot DEMO (D)** for the spoken drill; the notify beat posts the same ACK. LIVE stays empty until sensors are wired.
...
Pilot, the watch advisor, sits as a live voice channel at the bottom-right of every page — the field is the real speech wave, not a drawn or photographed person. Speech/type languages fold into a dropdown inside the panel.
