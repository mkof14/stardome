...
export const fr: Messages = {
  ...
  chrome: {
    rights: "© StarDome Inc. 2026 · Tous droits réservés",
  ...
  seo: {
    ...
    faq: "FAQ — StarDome",
    containers: "Conteneurs AGRON — StarDome",
    ...
    about: "Qui est derrière StarDome",
    contact: "Contact — StarDome",
    backend: "Backend — administration système — StarDome",
  ...
  legal: {
    ...
    privacySections: [
      ...
      { title: "Accès et partage", body: "L'accès suit les rôles Backend : Super Admin, Admin, Operator et Viewer. L'hébergement et la base traitent les données sur nos instructions lorsqu'un déploiement est connecté. Anthropic reçoit le message envoyé à Pilot pour que le conseiller réponde, pas pour le marketing StarDome." },
    ...
    termsIntro:
      "Ces conditions régissent le site StarWall et les écrans illustratifs StarDome 1, Pilot et Backend. L'usage opérationnel de StarWall sur un navire ou un site exige un accord écrit distinct avec StarDome.",
    termsSections: [
      { title: "Acceptation", body: "En utilisant ce site, vous acceptez ces conditions. StarDome peut les mettre à jour ; la date en tête de page s'applique." },
      { title: "StarDome 1 illustratif", body: "DEMO est un tableau de formation. Ce n'est pas un flux capteurs. LIVE montre le déploiement réel : sans équipement, le tableau est vide. Actions recommandées et réponses Pilot sont un conseil pour la personne de quart. Elles ne remplacent pas son jugement." },
  ...
  surface: {
    ...
    connectionsOut: "Information sortante (noyau → StarDome 1 / Support)",
  ...
  backend: {
    ...
    blackboxLead:
      "Enregistrements de cette session dans le navigateur — conversations Pilot et scénarios — écrits dans StarDome 1 et conservés en local.",
    blackboxLeadLive: "Aucun enregistrement de ce déploiement pour l'instant.",
    blackboxEmpty: "Aucun enregistrement pour l'instant.",
    blackboxOpen: "Ouvrir l'enregistreur dans StarDome 1 →",
    ...
    auditLead: "Actions administratives — distinctes du journal d'événements du StarDome 1.",
  ...
  auth: {
    ...
    leadLive:
      "Les mêmes comptes de démonstration en LIVE. Aucun capteur n'est encore relié ; l'administration utilise cette session.",
    nameLabel: "Nom",
    emailLabel: "E-mail ou demo",
    roleLabel: "Rôle",
    ...
    demoAccounts: "Démonstration d'idée",
    liveEmptyAccounts: "Aucun compte sur ce déploiement pour l'instant.",
    sessionNotice:
      "Session d'accès pour StarDome 1 et Backend. Les rôles sont appliqués sur les écritures.",
    sessionNoticeLive:
      "Les mêmes comptes qu'en DEMO. LIVE n'a toujours pas de capteurs.",
    nameRequired: "Saisissez un nom pour continuer.",
    emailInvalid: "Indiquez un e-mail valide.",
    ...
    signingIn: "Connexion…",
    credentialsError: "Ces identifiants n'ont pas été reconnus.",
    enterCredentials: "Saisissez votre e-mail et votre mot de passe.",
    demoHint:
      "Ceci est une démonstration d'idée. Connectez-vous avec demo / demo. Aucun mot de passe unique n'est publié ici.",
    ...
    forgotSent: "Aucun e-mail n'a été envoyé. Utilisez demo / demo pour ouvrir le parcours.",
    forgotSubmit: "Continuer",
    forgotLead:
      "Cette démonstration d'idée n'envoie pas d'e-mail de réinitialisation. Connectez-vous avec demo / demo.",
    ...
    signupThenLogin: "Compte créé. Connectez-vous depuis la page d'accès.",
    googleHostError: "La connexion n'a pas pu aboutir sur cet hôte. Essayez e-mail et mot de passe.",
    bodies: {
      ...
      blackbox: "Enregistrements de session du StarDome 1 conservés dans ce navigateur.",
      integrations: "Registre des flux — radar, AIS, caméras, satcom.",
      audit: "Actions administratives, distinctes du journal d'événements du StarDome 1.",
      overview: "Présentation et cartes d'entrée du site public.",
      how: "Connecter, comprendre, décider — architecture et capacités.",
      bridge: "StarDome 1 — image situationnelle et scénarios.",
      connections: "Carte du cœur, des capteurs, du StarDome 1 et du Support Center.",
      ...
      containers: "Matériel conteneur StarDome déployable qui fait tourner StarWall.",
      about: "Qui construit StarWall, ce que nous défendons, et comment parler d'un déploiement.",
      contact: "Demander un briefing avec StarDome Maritime.",
    },
  },
  home: {
    kicker: "StarDome",
    ...
    points: [
      ...
      "Se connecte directement au Security Support Center de StarDome lorsque c'est nécessaire",
    ],
    contactCta: "Contacter StarDome Maritime",
    pdfCta: "Télécharger la présentation (PDF)",
    cards: [
      { title: "Fonctionnement", body: "Connecter, comprendre, décider — en trois étapes" },
      { title: "Voir en action", body: "Un aperçu interactif de l'interface StarDome 1" },
    ...
    interfaceTitle: "Ce qui est sur StarDome 1 aujourd'hui",
    interfaceLead:
      "Le StarDome 1 est le tableau de travail, pas une diapositive. Voici les parties déjà construites sur /interface, y compris un LIVE honnête quand rien n'est encore relié.",
    interfaceCta: "Ouvrir StarDome 1",
    interfacePoints: [
      { title: "Image de situation", body: "Une carte des contacts depuis les sources du tableau — radar, caméras, AIS et le reste — au lieu d'une pile d'écrans." },
      ...
      { title: "Barre de saut", body: "Aller droit entre tableau, risque, systèmes, journal, apprentissage, Black Box, Pilot et la carte des liaisons." },
      ...
      { title: "Black Box, carte, Pilot", body: "Enregistrements de session dans la Black Box, carte de topologie des capteurs vers le cœur et StarDome 1, et Pilot — le conseiller de quart." },
    ],
    containersLink: "StarWall fonctionne aussi dans le matériel conteneur déployable de StarDome →",
  },
  how: {
    ...
    steps: [
      ...
      {
        title: "Décider",
        body: "Un niveau de risque clair, avec les raisons visibles, et si besoin une ligne directe vers le Security Support Center de StarDome.",
      },
    ],
    ...
    capabilities: [
      ...
      {
        title: "Relié au Support Center de StarDome",
  ...
  walkthrough: {
    ...
    steps: [
      ...
      "StarDome 1 affiche une recommandation claire : appeler sur VHF ch.16, renforcer la veille, être prêt à modifier la route si la distance passe sous 1.0 NM.",
  ...
  bridge: {
    ...
    disclaimer: "© StarDome Inc. · StarWall — interface de démonstration, données illustratives, pas un navire réel.",
  ...
  levels: {
    ...
    mapNote:
      "Ces niveaux correspondent à la structure de service actuelle de StarDome Maritime : LIGHT et ADVANCED s'inscrivent dans Protect ; INTELLIGENCE et CUSTOM s'étendent à Intelligence + Support.",
  ...
  pricing: {
    ...
    lead: "Choisissez l'objet, le niveau StarWall, le matériel StarDome Container et les options. L'estimation à droite se met à jour — le mensuel logiciel et l'équipement unique restent séparés.",
    ...
    contactAgron: "Contacter StarDome",
    disclaimer:
    ...
    faq1aBefore:
      "L'StarDome Security Gateway et l'installation sur votre objet. Le matériel StarDome Container est facturé séparément — voir",
    ...
    config: {
      ...
      stepContainer: "Materiel StarDome Container",
      ...
      customQuote: "Contactez StarDome pour un devis sur mesure",
  ...
  contact: {
    ...
    success:
      "Demande enregistrée. Une copie est envoyée seulement si cette installation a une boîte configurée.",
    error: "La demande n'a pas pu être enregistrée. Réessayez.",
    required: "Ce champ est obligatoire.",
    invalidEmail: "Saisissez une adresse valide.",
  },
  containers: {
    kicker: "StarDome · CONTENEUR DE SÉCURITÉ DÉPLOYABLE",
  ...
  about: {
    kicker: "À propos",
    title: "Qui est derrière StarDome",
    lead:
