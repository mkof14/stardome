...
export type PilotDeskCopy = {
  ...
  ack: string;
  acceptAdvice: string;
  declineAdvice: string;
  acceptedLogged: string;
  declinedLogged: string;
  designatedAck: string;
  designatedSeen: string;
  ask: string;
  support: string;
  watchNet: string;
  satcom: string;
...
const DESK = {
  en: {
    ...
    ack: "Acknowledged",
    acceptAdvice: "Accept",
    declineAdvice: "Decline",
    acceptedLogged: "Accepted. Logged in the Black Box. You still own the watch.",
    declinedLogged: "Declined. Logged in the Black Box. I stay on the picture.",
    designatedAck: "DESIGNATED: ACK. I have the alarm. Standing by.",
    designatedSeen: "DESIGNATED: Received. Moving to the watch.",
    ask: "Ask Pilot",
    ...
    unreadGo: "Open Pilot — orange button below",
    unreadWhere: "The note is on Advice",
    unreadHere: "New note is here — Advice",
    unreadOpen: "Open Pilot",
  ...
  es: {
    ...
    ack: "Enterado",
    acceptAdvice: "Aceptar",
    declineAdvice: "Rechazar",
    acceptedLogged: "Aceptado. Registrado en la caja negra. La guardia sigue siendo suya.",
    declinedLogged: "Rechazado. Registrado en la caja negra. Sigo en la imagen.",
    designatedAck: "DESIGNADA: ACK. Tengo la alarma. En espera.",
    designatedSeen: "DESIGNADA: Recibido. Voy a la guardia.",
    ...
    unreadGo: "Abra Pilot — botón naranja abajo",
    unreadWhere: "La nota está en Consejo",
    unreadHere: "Nota nueva — aquí, en Consejo",
    unreadOpen: "Abrir Pilot",
  ...
  fr: {
    ...
    ack: "Pris en compte",
    acceptAdvice: "Accepter",
    declineAdvice: "Refuser",
    acceptedLogged: "Accepté. Consigné dans la boîte noire. Le quart reste le vôtre.",
    declinedLogged: "Refusé. Consigné dans la boîte noire. Je reste sur l’image.",
    designatedAck: "DÉSIGNÉE : ACK. J’ai l’alarme. En attente.",
    designatedSeen: "DÉSIGNÉE : Reçu. Je vais au quart.",
    ...
    unreadGo: "Ouvrez Pilot — bouton orange en bas",
    unreadWhere: "La note est dans Conseil",
    unreadHere: "Nouvelle note — ici, dans Conseil",
    unreadOpen: "Ouvrir Pilot",
  ...
  de: {
    ...
    train: "Wachordnung",
    ack: "Zur Kenntnis",
    acceptAdvice: "Annehmen",
    declineAdvice: "Ablehnen",
    acceptedLogged: "Angenommen. In der Black Box vermerkt. Die Wache bleibt bei Ihnen.",
    declinedLogged: "Abgelehnt. In der Black Box vermerkt. Ich bleibe am Lagebild.",
    designatedAck: "BENANNTE: ACK. Alarm bei mir. Bereit.",
    designatedSeen: "BENANNTE: Empfangen. Ich gehe zur Wache.",
    ask: "Pilot fragen",
    support: "Support Center",
    watchNet: "Wache-Netz",
    satcom: "Satcom",
    ...
    unreadGo: "Pilot öffnen — orangefarbene Taste unten",
    unreadWhere: "Die Notiz liegt unter Rat",
    unreadHere: "Neue Notiz — hier unter Rat",
    unreadOpen: "Pilot öffnen",
  ...
  ru: {
    ...
    ack: "Принято",
    acceptAdvice: "Принять",
    declineAdvice: "Отклонить",
    acceptedLogged: "Принято. Записано в чёрный ящик. Решение на вахте за вами.",
    declinedLogged: "Отклонено. Записано в чёрный ящик. Остаюсь на картине.",
    designatedAck: "НАЗНАЧЕННЫЙ: ПРИНЯЛ. Тревога у меня. На связи.",
    designatedSeen: "НАЗНАЧЕННЫЙ: Получил. Иду на вахту.",
    ask: "Спросить Pilot",
    support: "Support Center",
    watchNet: "Сеть вахты",
    satcom: "Satcom",
    ...
    unreadGo: "Откройте Pilot — оранжевая кнопка внизу",
    unreadWhere: "Записка во вкладке Совет",
    unreadHere: "Новая записка — здесь, во вкладке Совет",
    unreadOpen: "Открыть Pilot",
  ...
  uk: {
    ...
    ack: "Прийнято",
    acceptAdvice: "Прийняти",
    declineAdvice: "Відхилити",
    acceptedLogged: "Прийнято. Записано в чорний ящик. Рішення на вахті за вами.",
    declinedLogged: "Відхилено. Записано в чорний ящик. Лишаюся на картині.",
    designatedAck: "ПРИЗНАЧЕНИЙ: ПРИЙНЯВ. Тривога в мене. На зв’язку.",
    designatedSeen: "ПРИЗНАЧЕНИЙ: Отримав. Іду на вахту.",
    ask: "Запитати Pilot",
    support: "Support Center",
    ...
    unreadGo: "Відкрийте Pilot — помаранчева кнопка внизу",
    unreadWhere: "Записка у вкладці Порада",
    unreadHere: "Нова записка — тут, у вкладці Порада",
    unreadOpen: "Відкрити Pilot",
    seePicture: "Читаю {panel}.",
    step: "Наступний крок",
    protocol: "Протокол",
  ...
  ar: {
    ...
    acceptAdvice: "قبول",
    declineAdvice: "رفض",
    acceptedLogged: "قُبل. سُجّل في الصندوق الأسود. الخفارة تبقى لكم.",
    declinedLogged: "رُفض. سُجّل في الصندوق الأسود. أبقى على الصورة.",
    designatedAck: "المعيّن: تم. الإنذار عندي. في الانتظار.",
    designatedSeen: "المعيّن: وصلت. أتجه إلى الخفارة.",
    ask: "اسأل Pilot",
    support: "Support Center",
    ...
    unreadGo: "افتحوا Pilot — الزر البرتقالي أسفل",
    unreadWhere: "الملاحظة في تبويب المشورة",
    unreadHere: "ملاحظة جديدة — هنا في المشورة",
    unreadOpen: "افتحوا Pilot",
  ...
  zh: {
    ...
    acceptAdvice: "接受",
    declineAdvice: "拒绝",
    acceptedLogged: "已接受。已记入黑匣子。值班决定仍由你做出。",
    declinedLogged: "已拒绝。已记入黑匣子。我继续看画面。",
    designatedAck: "指定人员：收到。警报在我这边。待命。",
    designatedSeen: "指定人员：收到。正在前往值班。",
    ask: "询问 Pilot",
    support: "Support Center",
    watchNet: "值班网",
    satcom: "Satcom",
    ...
    unreadGo: "打开 Pilot — 下方橙色按钮",
    unreadWhere: "备注在「建议」页",
    unreadHere: "新备注在这里 —「建议」",
    unreadOpen: "打开 Pilot",
  ...
  ja: {
    ...
    acceptAdvice: "受ける",
    declineAdvice: "却下",
    acceptedLogged: "受領。ブラックボックスに記録しました。当直の判断はあなたです。",
    declinedLogged: "却下。ブラックボックスに記録しました。画面を継続します。",
    designatedAck: "指定者: 了解。警報はこちら。待機。",
    designatedSeen: "指定者: 受信。当直へ向かいます。",
    ask: "Pilot に尋ねる",
    support: "Support Center",
    watchNet: "当直ネット",
    satcom: "Satcom",
    ...
    unreadGo: "Pilot を開く — 下のオレンジボタン",
    unreadWhere: "メモは「助言」タブにあります",
    unreadHere: "新しいメモはここ — 助言",
    unreadOpen: "Pilot を開く",
  ...
  he: {
    ...
    acceptAdvice: "לקבל",
    declineAdvice: "לדחות",
    acceptedLogged: "התקבל. נרשם בקופסה השחורה. ההחלטה במשמרת שלכם.",
    declinedLogged: "נדחה. נרשם בקופסה השחורה. נשאר על התמונה.",
    designatedAck: "הממונה: ACK. האזעקה אצלי. בהמתנה.",
    designatedSeen: "הממונה: התקבל. בדרך למשמרת.",
    ask: "לשאול את Pilot",
    support: "Support Center",
    watchNet: "רשת משמרת",
    satcom: "Satcom",
    ...
    unreadGo: "פתחו את Pilot — הכפתור הכתום למטה",
    unreadWhere: "הפתק בלשונית ייעוץ",
    unreadHere: "פתק חדש — כאן בלשונית ייעוץ",
    unreadOpen: "פתחו את Pilot",
