...
const en: PlansDeskCopy = {
  ...
  title: "Open the StarDome price book",
...
const ru: PlansDeskCopy = {
  ...
  title: "Открыть стол цен StarDome",
...
const uk: PlansDeskCopy = {
  ...
  title: "Відкрити стіл цін StarDome",
...
const es: PlansDeskCopy = {
  ...
  title: "Abrir el libro de precios StarDome",
...
const fr: PlansDeskCopy = {
  ...
  title: "Ouvrir le livre des prix StarDome",
...
const de: PlansDeskCopy = {
  ...
  title: "StarDome-Preisbuch öffnen",
...
const he: PlansDeskCopy = {
  ...
  title: "לפתוח את ספר המחירים של StarDome",
