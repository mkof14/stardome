...
export const en: Messages = {
  ...
  seo: {
    home: "StarDome — Maritime Security Intelligence",
    howItWorks: "How it works — StarDome",
    interface: "AGRON 1",
    levels: "Subscription Levels — StarDome",
    pricing: "Plans — StarDome",
    technology: "Equipment & Integration — StarDome",
    faq: "FAQ — StarDome",
    containers: "AGRON containers — StarDome",
    ...
    login: "Sign in — StarDome",
    tasks: "All tasks — StarDome",
    signup: "Sign up — StarDome",
    forgotPassword: "Forgot password — StarDome",
    privacy: "Privacy — StarDome",
    terms: "Terms of Service — StarDome",
  },
  legal: {
  ...
  auth: {
    ...
    signUpLink: "Sign up",
    signUpTitle: "Create a StarDome account",
  ...
  home: {
    ...
    containersLink: "AGRON containers and StarDome systems →",
  },
  how: {
  ...
  containers: {
    ...
    lead: "AGRON is the steel — the box on a quay, a deck, an island road, or a van. StarDome is the system inside. Detection and the picture run on StarWall. Some tiers can carry a response bay. That bay does not fire itself. A person authorizes it, and local law still applies.",
    contact: "Contact StarDome",
