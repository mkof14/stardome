...
export const he: Messages = {
  ...
  legal: {
    ...
    privacySections: [
      ...
      { title: "איזה מידע מעבדים", body: "אם יוצרים חשבון נשמרים האימייל וגיבוב הסיסמה (או מזהה ספק הכניסה) והתפקיד. טופס יצירת הקשר שולח את מה שהקלדתם. הדפדפן שומר שפה, ערכת נושא ו־DEMO/LIVE מקומית. יומנים, Black Box ושיחות Pilot נכתבים קודם במכשיר; הם מגיעים למסד הפריסה רק אם הוא מוגדר. איננו משתמשים בתוכן Bridge או Pilot לאימון מודלים." },
