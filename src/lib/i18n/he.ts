...
export const he: Messages = {
  ...
  chrome: {
    ...
    footerLegal: "משפטי",
    footerBlurb:
      "StarWall by AGRON — תמונה אחת מהציוד שכבר יש, וצעד הבא ברור למי שבמשמרת.",
  },
  seo: {
  ...
  legal: {
    ...
    privacySections: [
      ...
      { title: "איזה מידע מעבדים", body: "אם יוצרים חשבון נשמרים האימייל וגיבוב הסיסמה (או מזהה ספק הכניסה) והתפקיד. בקשות יצירת קשר ותצורה שומרות שם, דוא״ל, הודעה ופרטי ארגון, טלפון או סוג נכס אם ציינתם — כליד במסד הפריסה אם הוא מוגדר, אחרת בקובץ מקומי. עותק נשלח בדוא״ל או ל-webhook רק אם השירותים האלה מוגדרים. הדפדפן שומר שפה, ערכת נושא ו־DEMO/LIVE מקומית. יומנים, Black Box ושיחות Pilot נכתבים קודם במכשיר; הם מגיעים למסד הפריסה רק אם הוא מוגדר. איננו משתמשים בתוכן AGRON 1 או Pilot לאימון מודלים." },
    ...
    termsSections: [
      ...
      { title: "קניין, אחריות, קשר", body: "StarWall, AGRON והלוגו הם סימני AGRON. התוכן ניתן «כפי שהוא». AGRON אינה אחראית להחלטות שהתקבלו רק מהדמו הציבורי או מ־Pilot באתר זה. שאלות: /contact או agron1.com." },
    ],
  },
  surface: {
  ...
  pricing: {
    ...
    getStarted: "להתחיל",
    contactAgron: "יצירת קשר עם AGRON",
    disclaimer:
    ...
    faq1aBefore:
      "שער AGRON Security Gateway וההתקנה באובייקט שלכם. חומרת AGRON Container מתומחרת בנפרד — ראו",
  ...
  about: {
    ...
    teamField:
      "אלה מקצוענים של AGRON עם ניסיון מעשי רב בתנאים אמיתיים. הם עבדו במצבים קריטיים שבהם צריך להחליט מהר — בלי דו־משמעות ובלי זכות לבזבז זמן. הניסיון הזה מעצב את StarWall: תמונה אחת וצעד הבא אחד למי שצריך לפעול.",
    teamPoints: [
      {
        title: "תנאים אמיתיים",
    ...
    agronAfter: ".",
    agronTeam:
      "מאחורי AGRON עומדים קודם כול אנשי שטח ומהנדסים: מקצוענים שנדרשו להחליט מהר בשטח — ואחר כך בנו את הכלים שחסרו להם.",
    todayCta:
