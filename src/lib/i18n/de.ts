...
export const de: Messages = {
  ...
  chrome: {
    rights: "© StarDome Inc. 2026 · Alle Rechte vorbehalten",
  ...
  seo: {
    ...
    interface: "StarDome 1 — interaktive Demonstration — StarWall by StarDome",
  ...
  legal: {
    ...
    privacySections: [
      ...
      { title: "Zugriff und Weitergabe", body: "Zugriff folgt den Backend-Rollen: Super Admin, Admin, Operator und Viewer. Hosting und Datenbank verarbeiten Daten nach unserer Weisung, wenn ein Einsatz verbunden ist. Anthropic erhält die Nachricht an Pilot, damit der Berater antworten kann — nicht für StarDome-Marketing." },
    ...
    termsIntro:
      "Diese Bedingungen gelten für die StarWall-Website und die hier veröffentlichten illustrativen StarDome 1-, Pilot- und Backend-Oberflächen. Der Betrieb von StarWall als Arbeitssystem braucht eine gesonderte schriftliche Vereinbarung mit StarDome.",
    termsSections: [
      { title: "Annahme", body: "Mit der Nutzung dieser Website akzeptieren Sie diese Bedingungen. StarDome kann sie aktualisieren; maßgeblich ist das Datum am Seitenanfang." },
      { title: "Illustrativer StarDome 1", body: "DEMO ist ein Ausbildungslagebild. Es ist kein Sensorfeed. LIVE zeigt den echten Einsatz: ohne Gerät ist das Bild leer. Empfohlene Handlungen und Pilot-Antworten sind Rat für die Wache. Sie ersetzen deren Urteil nicht." },
  ...
  surface: {
    ...
    connectionsOut: "Information aus (Kern → StarDome 1 / Support)",
    connectionsOff: "Nicht verbunden",
    helmTitle: "Pilot",
    helmAdvisor: "WACHBERATER",
    helmAsk: "Pilot fragen…",
    helmSend: "Senden",
    helmHide: "Ausblenden",
    helmOpen: "Pilot öffnen",
    helmEmpty:
      "Pilot hat Wache. Fragen Sie zu StarWall, dem StarDome 1-Lagebild, den Plänen oder StarDome-Containern — Sprache oder Text. Nur Rat; Sie entscheiden.",
  ...
  backend: {
    ...
    helmReady: "Pilot-API konfiguriert",
    helmMissing: "Pilot-API-Schlüssel fehlt",
    ...
    blackboxLead:
      "Sitzungsaufzeichnungen in diesem Browser — Pilot-Gespräche und Szenarien — werden auf der StarDome 1 geschrieben und lokal gehalten.",
    blackboxLeadLive: "Noch keine Aufzeichnungen dieser Installation.",
    blackboxEmpty: "Noch keine Aufzeichnungen.",
    blackboxOpen: "Rekorder auf der StarDome 1 öffnen →",
    ...
    auditLead: "Administrative Aktionen — getrennt vom Ereignisprotokoll der StarDome 1.",
    ...
    notifyNote:
      "Diese Demonstration speichert nur die Routingtabelle. E-Mail, SMS, Anrufe und Messenger werden aus dieser Ideenvorschau nicht gesendet.",
  ...
  auth: {
    ...
    leadLive:
      "Dieselben Demokonten in LIVE. Noch keine Sensoren; die Verwaltung nutzt diese Sitzung.",
    nameLabel: "Name",
    emailLabel: "E-Mail oder demo",
    roleLabel: "Rolle",
    ...
    signingIn: "Anmeldung…",
    credentialsError: "Diese Zugangsdaten wurden nicht erkannt.",
    enterCredentials: "E-Mail und Passwort eingeben.",
    demoHint:
      "Das ist eine Ideendemonstration. Melden Sie sich mit demo / demo an. Hier stehen keine individuellen Passwörter.",
    ...
    forgotSent: "Es wurde keine E-Mail gesendet. Nutzen Sie demo / demo für den Rundgang.",
    forgotSubmit: "Weiter",
    forgotLead:
      "Diese Ideendemonstration sendet keine Reset-Mails. Melden Sie sich mit demo / demo an.",
    ...
    signupFailed: "Konto konnte nicht angelegt werden.",
    signupThenLogin: "Konto angelegt. Melden Sie sich auf der Anmeldeseite an.",
    googleHostError: "Die Anmeldung auf diesem Host ist fehlgeschlagen. E-Mail und Passwort versuchen.",
    bodies: {
      ...
      blackbox: "StarDome 1-Sitzungsaufzeichnungen in diesem Browser.",
      integrations: "Register der Feeds — Radar, AIS, Kameras, Satcom.",
      audit: "Administrative Aktionen, getrennt vom Ereignisprotokoll der StarDome 1.",
      ...
      bridge: "StarDome 1 — Lagebild und Szenarien.",
      connections: "Karte von Kern, Sensoren, StarDome 1 und Support Center.",
      ...
      containers: "Einsatzfähige StarDome-Containerhardware mit StarWall.",
      about: "Wer StarWall baut, wofür wir stehen und wie ein Einsatz besprochen wird.",
      contact: "Ein Briefing mit StarDome Maritime anfragen.",
    },
  },
  home: {
    ...
    points: [
      ...
      "Geht bei Bedarf direkt auf das Security Support Center von StarDome",
    ],
    contactCta: "StarDome Maritime kontaktieren",
    pdfCta: "Überblick herunterladen (PDF)",
    cards: [
      { title: "So funktioniert es", body: "Verbinden, verstehen, entscheiden — in drei Schritten" },
      { title: "Im Einsatz sehen", body: "Ein interaktiver Blick auf die StarDome 1-Oberfläche" },
    ...
    interfaceTitle: "Was heute auf StarDome 1 liegt",
    interfaceLead:
    ...
    containersLink: "StarWall läuft auch in der verlegbaren Container-Hardware von StarDome →",
  },
  how: {
    ...
    steps: [
      ...
      {
        title: "Entscheiden",
        body: "Ein klares, nachvollziehbares Risikoniveau und bei Bedarf eine direkte Leitung zum Security Support Center von StarDome.",
      },
    ],
    ...
    capabilities: [
      ...
      {
        title: "Angebunden an das Support Center von StarDome",
  ...
  walkthrough: {
    ...
    steps: [
      ...
      "StarDome 1 zeigt eine klare Empfehlung: auf VHF ch.16 rufen, Wache verstärken, bereit sein, den Kurs zu ändern, wenn die Distanz unter 1.0 NM fällt.",
  ...
  bridge: {
    ...
    disclaimer: "© StarDome Inc. · StarWall — Demonstrationsoberfläche, illustrative Daten, kein reales Schiff.",
    risks: ["Normal", "Achtung", "Erhöht", "Kritisch"],
    systems: [
      "Radar",
      "AIS",
      "CCTV · 6 Kameras",
  ...
  levels: {
    ...
    mapNote:
      "Diese Stufen entsprechen der bestehenden Servicestruktur von StarDome Maritime: LIGHT und ADVANCED liegen in Protect, INTELLIGENCE und CUSTOM erweitern Intelligence + Support.",
  ...
  pricing: {
    ...
    lead: "Wählen Sie Objekt, StarWall-Stufe, StarDome-Container-Hardware und Extras. Die Schätzung rechts aktualisiert sich — monatliche Software und einmalige Ausrüstung bleiben getrennt.",
    ...
    getStarted: "Loslegen",
    contactAgron: "StarDome kontaktieren",
    disclaimer:
      "Auf dieser Seite steht kein Angebot. Die Zahl nennt die Person, die den Vertrag führt.",
    salesNote:
      "Plannamen und Leistungsumfang sind öffentlich. Die Zahl steht nicht auf der Seite. Sie kommt vom Vertrieb, der den Vertrag schreibt.",
    askSales: "Die Person am Vertrag schreiben",
    faqTitle: "Fragen zu den Plänen",
    faq1q: "Was ist in den einmaligen Ausrüstungskosten enthalten?",
    faq1aBefore:
      "Das StarDome Security Gateway und die Installation an Ihrem Objekt. StarDome-Container-Hardware wird separat berechnet — siehe",
    ...
    config: {
      ...
      customQuote: "Kontaktieren Sie StarDome fuer ein individuelles Angebot",
      ...
      quoteMessage:
        "Interesse an: {summary}. Bitte die Person, die den Vertrag führt, um den Preis.",
      objects: {
        yacht: {
  ...
  containers: {
    kicker: "StarDome · VERLEGBARER SICHERHEITSCONTAINER",
    ...
    cmLegal:
      "Gegenmaßnahmen-Ausrüstung ist auf ausgewählten Containerstufen verfügbar. Freischaltung oder Betrieb erfordern stets eine länderspezifische Genehmigung und eine lizenzierte Bedienung. Die Erfassungs- und Analyseschicht von StarDome Container (StarWall) löst diese Systeme niemals von selbst aus — die Aktivierung ist jedes Mal eine menschliche Entscheidung einer berechtigten Bedienung.",
    cmItems: [
      {
  ...
  about: {
    ...
    teamField:
      "Es sind StarDome-Profis mit großer praktischer Erfahrung unter realen Bedingungen. Sie haben kritische Lagen erlebt, in denen schnell entschieden werden muss — ohne Zweideutigkeit und ohne Zeit zu verlieren. Diese Erfahrung prägt StarWall: ein Lagebild, ein nächster Schritt, für die Person, die handeln muss.",
    teamPoints: [
      {
    ...
    contactCta: "StarDome kontaktieren",
  },
};
