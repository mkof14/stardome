...
export const zh: Messages = {
  ...
  chrome: {
    rights: "© StarDome Inc. 2026 · 保留所有权利",
    ...
    footerLegal: "法律",
    footerBlurb:
      "StarWall by StarDome — 用现有设备合成一幅态势，给值班人员明确的下一步。",
  },
  seo: {
    ...
    containers: "集装箱 — StarDome",
    containersDetection: "探测套件 — StarDome Containers",
    containersSpecs: "规格 — StarDome Containers",
    ...
    about: "为何选择 StarWall — StarWall by StarDome",
    contact: "联系 — StarWall by StarDome",
    backend: "StarWall Backend — 系统管理 — StarWall by StarDome",
    connections: "系统连接图 — StarWall by StarDome",
    login: "登录 — StarWall by StarDome",
    signup: "注册 — StarWall by StarDome",
    forgotPassword: "忘记密码 — StarWall by StarDome",
    tasks: "全部任务 — StarWall by StarDome",
    privacy: "隐私 — StarWall by StarDome",
    terms: "服务条款 — StarWall by StarDome",
  },
  legal: {
    privacyTitle: "隐私政策",
    ...
    privacySections: [
      ...
      { title: "访问与共享", body: "访问遵循 Backend 角色：Super Admin、Admin、Operator、Viewer。托管与数据库在部署已连接时按我们的指示处理数据。Anthropic 收到您发给 Pilot 的内容以便顾问回复，而非用于 StarDome 营销。" },
    ...
    termsIntro:
      "本条款适用于 StarWall 网站以及此处发布的说明性 StarDome 1、Pilot 与 Backend 界面。将 StarWall 作为作业系统使用，须另与 StarDome 签订书面协议。",
    termsSections: [
      { title: "接受", body: "使用本网站即表示接受本条款。StarDome 可更新条款；以页首日期为准。" },
      { title: "说明性 StarDome 1", body: "DEMO 是训练画面，不是传感器源。LIVE 显示真实部署：无设备则画面为空。推荐行动与 Pilot 回复是给值班人员的建议，不能代替其判断。" },
  ...
  surface: {
    ...
    connectionsOut: "信息出（核心 → StarDome 1 / Support）",
    connectionsOff: "未连接",
    helmTitle: "Pilot",
    helmAdvisor: "值班顾问",
    helmAsk: "询问 Pilot…",
    ...
    helmOpen: "打开 Pilot",
    helmEmpty:
      "Pilot 正在值班。可询问 StarWall、StarDome 1 画面、方案或 StarDome 集装箱 — 语音或文字。仅供建议，由您决定。",
  ...
  backend: {
    ...
    title: "系统管理",
    lead:
      "连通性、设备健康、访问控制与监控 — 包括 StarDome 集装箱硬件。比 StarDome 1 更密：面向管理员，而非一瞥值守。",
    demoNotice:
    ...
    heartbeatOk: "可达",
    heartbeatFail: "不可达",
    helmReady: "Pilot API 已配置",
    helmMissing: "未设置 Pilot API 密钥",
    equipmentTitle: "设备监控",
    colEquipment: "设备",
    colStatus: "状态",
    colCheck: "上次自检",
    ...
    blackboxLead:
      "本浏览器会话记录 — Pilot 对话与场景运行 — 在 StarDome 1 写入并本地保留。",
    blackboxLeadLive: "此部署尚无记录。",
    blackboxEmpty: "尚无记录。",
    blackboxOpen: "在 StarDome 1 打开记录器 →",
    conversation: "对话",
    scenarioRun: "场景",
    ...
    testFail: "无数据流",
    auditTitle: "审计日志",
    auditLead: "管理操作 — 与 StarDome 1 事件日志分开。",
    noAudit: "尚无管理操作。",
    exportAudit: "导出日志",
    justNow: "刚刚",
    secondsAgo: "秒前",
  ...
  auth: {
    ...
    title: "登录 StarWall",
    lead:
      "这是想法演示。使用 demo / demo 登录。若已接入数据库，新账户默认为 Operator。",
    leadLive:
      "LIVE 使用同一套演示账户。尚未接入传感器；管理仍通过此会话。",
    nameLabel: "姓名",
    emailLabel: "邮箱或 demo",
    roleLabel: "角色",
    ...
    sessionNotice:
      "用于 StarDome 1 与 Backend 的登录会话。写入操作会检查角色。",
    sessionNoticeLive:
    ...
    forgotLink: "忘记密码？",
    signingIn: "正在登录…",
    credentialsError: "无法识别这些凭据。",
    enterCredentials: "请输入邮箱和密码。",
    demoHint:
      "这是产品想法演示。使用 demo / demo 登录。此处不公布独立密码。",
    noAccount: "还没有账户？",
    hasAccount: "已有账户？",
    signUpLink: "注册",
    signUpTitle: "创建 StarWall 账户",
    organizationOptional: "组织（可选）",
    confirmPassword: "确认密码",
    creatingAccount: "正在创建账户…",
    signUpAction: "注册",
    forgotTitle: "重置密码",
    forgotSent: "没有发送邮件。使用 demo / demo 打开演示。",
    forgotSubmit: "继续",
    forgotLead:
      "此想法演示不会发送重置邮件。请用 demo / demo 登录。",
    backToSignIn: "← 返回登录",
    orDivider: "或",
    enterName: "请输入姓名。",
    enterValidEmail: "请输入有效邮箱。",
    passwordShort: "密码至少 8 个字符。",
    passwordMismatch: "两次密码不一致。",
    signupFailed: "无法创建账户。",
    signupThenLogin: "账户已创建。请从登录页进入。",
    googleHostError: "此主机上的登录未能完成。请改用邮箱和密码。",
    bodies: {
      health: "服务心跳、链路与备份路径。",
      equipment: "已连接设备的诊断与自检。",
      access: "角色层级。Super Admin 管理用户。",
      blackbox: "保存在本浏览器的 StarDome 1 会话记录。",
      integrations: "数据流登记 — 雷达、AIS、摄像、卫通。",
      audit: "管理操作，独立于 StarDome 1 事件日志。",
      overview: "公开站点概览与入口卡片。",
      how: "连接、理解、决策 — 架构与能力。",
      bridge: "StarDome 1 — 态势图与场景。",
      connections: "核心、传感器、StarDome 1 与 Support Center 的地图。",
      ...
      containers: "运行 StarWall 的 StarDome 可部署集装箱设备。",
      about: "谁在构建 StarWall、我们坚持什么，以及如何讨论部署。",
      contact: "向 StarDome Maritime 申请简报。",
    },
  },
  home: {
    kicker: "StarWall, StarDome",
    title: "值班的是人。屏幕不该互相打架。",
    lead: "游艇、码头、港口或岛上多半已有雷达和摄像机。麻烦是它们不同步。StarWall 读已经买过的设备，放到一块 StarDome 1 上。然后说出它会走哪一步。你接不接，是你的事。",
    points: [
      "对接现有设备即可工作 — 无需更换",
      "学习您的船舶或场地，运行越久越精准",
      "关键时刻直接接通 StarDome 的 Security Support Center",
    ],
    contactCta: "联系 StarDome Maritime",
    pdfCta: "下载概览（PDF）",
    cards: [
      { title: "工作原理", body: "接入、理解、决策 — 三步完成" },
      { title: "看实际效果", body: "交互查看 StarDome 1 界面" },
      { title: "层级", body: "从必要监测到完全定制构建" },
      { title: "设备", body: "对接什么，如何对接" },
    ],
    interfaceKicker: "StarDome 1",
    interfaceTitle: "StarDome 1 上现在有什么",
    interfaceLead:
    ...
    containersLink: "StarWall 也可运行于 StarDome 可部署集装箱硬件之中 →",
  },
  how: {
    kicker: "工作原理",
    title: "接入、理解、决策",
    ...
    steps: [
      ...
      {
        title: "决策",
        body: "清晰、可解释的风险等级，必要时直连 StarDome 的 Security Support Center。",
      },
    ],
    architecture: "架构",
    architectureLabel:
    ...
    capabilities: [
      ...
      {
        title: "连通 StarDome 的 Support Center",
  ...
  walkthrough: {
    ...
    steps: [
      ...
      "StarDome 1 给出一条明确建议：在 VHF ch.16 呼叫，加强值班，若距离降至 1.0 NM 以下则准备改向。",
  ...
  bridge: {
    ...
    simulate: "模拟告警",
    resolve: "解除并复位",
    disclaimer: "© StarDome Inc. · StarWall — 演示界面，示意数据，并非实船。",
    risks: ["正常", "注意", "升高", "危急"],
    systems: [
      "雷达",
      "AIS",
  ...
  levels: {
    ...
    honestySr: "现已提供与开发中",
    mapNote:
      "这些层级对应 StarDome Maritime 现有服务结构：LIGHT 与 ADVANCED 属于 Protect，INTELLIGENCE 与 CUSTOM 延伸至 Intelligence + Support。",
  ...
  pricing: {
    kicker: "价格",
    title: "配置您的部署",
    lead: "选择对象、StarWall 层级、StarDome Container 硬件和附加项。右侧估价随配置更新 — 月度软件与一次性设备费用分开显示。",
    mostPopular: "最常选择",
    perMonth: "quoted",
    equipmentPrefix: "+",
    ...
    faq1q: "一次性设备费用包含什么？",
    faq1aBefore:
      "StarDome Security Gateway 以及在您对象上的安装。StarDome Container 硬件另行计价 — 见",
  ...
  contact: {
    ...
    sending: "记录中…",
    success:
      "请求已记录。仅当本部署配置了邮箱时，才会发送邮件副本。",
    error: "无法记录请求。请重试。",
    required: "此项为必填。",
    invalidEmail: "请输入有效的电子邮箱。",
  },
  containers: {
    kicker: "StarDome · 可部署安保集装箱",
    title: "一个集装箱。全谱态势感知。",
    ...
    cmTitle: "反制措施",
    cmLegal:
      "反制设备在选定集装箱层级提供。启用或操作始终需要管辖区专项授权及持证操作员。StarDome Container 的探测与分析层（StarWall）绝不会自行触发这些系统 — 每次启动都是由授权操作员作出的人为决定。",
    cmItems: [
      {
        name: "拦截无人机系统",
  ...
  about: {
    ...
    teamField:
      "他们是 StarDome 的专业人士，在真实环境中积累了大量实践经验。他们经历过必须迅速决断的危急局面——不容含糊，也没有拖延的余地。这份经验决定了 StarWall 的形态：一幅态势、下一步行动，交给必须行动的人。",
    teamPoints: [
      {
        title: "真实条件",
