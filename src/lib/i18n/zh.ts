...
export const zh: Messages = {
  ...
  chrome: {
    ...
    footerLegal: "法律",
    footerBlurb:
      "StarDome — 用现有设备合成一幅态势，给值班人员明确的下一步。",
  },
  seo: {
    home: "StarDome — 海上安全情报",
    howItWorks: "工作原理 — StarDome",
    interface: "AGRON 1",
    levels: "订阅层级 — StarDome",
    pricing: "方案 — StarDome",
    technology: "设备与集成 — StarDome",
    faq: "FAQ — StarDome",
    ...
    about: "为何选择 StarWall — StarDome",
    contact: "联系 — StarDome",
    backend: "StarWall Backend — 系统管理 — StarDome",
    connections: "系统连接图 — StarDome",
    login: "登录 — StarDome",
    signup: "注册 — StarDome",
    forgotPassword: "忘记密码 — StarDome",
    tasks: "全部任务 — StarDome",
    privacy: "隐私 — StarDome",
    terms: "服务条款 — StarDome",
  },
