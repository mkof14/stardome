...
export const ja: Messages = {
  ...
  chrome: {
    ...
    footerLegal: "法務",
    footerBlurb:
      "StarDome — 既存の装備から一枚の絵と、当直者への明確な次の一手。",
  },
  seo: {
    home: "StarDome — 海上セキュリティインテリジェンス",
    howItWorks: "仕組み — StarDome",
    interface: "AGRON 1",
    levels: "サブスクリプションレベル — StarDome",
    pricing: "プラン — StarDome",
    technology: "装備と統合 — StarDome",
    faq: "FAQ — StarDome",
    ...
    about: "なぜ StarWall か — StarDome",
    contact: "お問い合わせ — StarDome",
    backend: "StarWall Backend — システム管理 — StarDome",
    connections: "接続マップ — StarDome",
    login: "サインイン — StarDome",
    signup: "アカウント作成 — StarDome",
    forgotPassword: "パスワードを忘れた — StarDome",
    tasks: "すべてのタスク — StarDome",
    privacy: "プライバシー — StarDome",
    terms: "利用規約 — StarDome",
  },
  legal: {
