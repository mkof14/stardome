...
export const ja: Messages = {
  ...
  chrome: {
    rights: "© StarDome Inc. 2026 · 無断転載を禁じます",
    ...
    footerLegal: "法務",
    footerBlurb:
      "StarWall by StarDome — 既存の装備から一枚の絵と、当直者への明確な次の一手。",
  },
  seo: {
    ...
    containers: "コンテナ — StarDome",
    containersDetection: "探知スイート — StarDome Containers",
    containersSpecs: "仕様 — StarDome Containers",
    ...
    about: "なぜ StarWall か — StarWall by StarDome",
    contact: "お問い合わせ — StarWall by StarDome",
    backend: "StarWall Backend — システム管理 — StarWall by StarDome",
    connections: "接続マップ — StarWall by StarDome",
    login: "サインイン — StarWall by StarDome",
    signup: "アカウント作成 — StarWall by StarDome",
    forgotPassword: "パスワードを忘れた — StarWall by StarDome",
    tasks: "すべてのタスク — StarWall by StarDome",
    privacy: "プライバシー — StarWall by StarDome",
    terms: "利用規約 — StarWall by StarDome",
  },
  legal: {
    ...
    privacySections: [
      ...
      { title: "アクセスと共有", body: "アクセスは Backend の役割に従います（Super Admin、Admin、Operator、Viewer）。ホスティングとデータベースは展開が接続されているとき当社の指示で処理します。Anthropic は Pilot へ送った内容を受け取り、助言者が返信するためであり、StarDome の宣伝のためではありません。" },
    ...
    termsIntro:
      "本規約は StarWall サイトと、ここに公開する StarDome 1、Pilot、Backend の説明画面に適用します。運用システムとしての利用には StarDome との別途書面契約が必要です。",
    termsSections: [
      { title: "承諾", body: "本サイトの利用により本規約に同意したものとします。StarDome は更新でき、ページ先頭の日付が適用されます。" },
      { title: "説明用 StarDome 1", body: "DEMO は訓練用の絵でありセンサー源ではありません。LIVE は実展開です。装備が無ければ空です。推奨行動と Pilot の返信は当直者への助言であり、判断の代わりではありません。" },
  ...
  surface: {
    ...
    connectionsOut: "情報出力（コア → StarDome 1 / Support）",
    connectionsOff: "未接続",
    helmTitle: "Pilot",
    ...
    helmOpen: "Pilot を開く",
    helmEmpty:
      "Pilot は当直中です。StarWall、StarDome 1 の画面、プラン、StarDome コンテナについて音声または文字で尋ねてください。助言のみ。判断はあなたです。",
  ...
  backend: {
    ...
    title: "システム管理",
    lead:
      "接続、機器の健全性、アクセス制御、監視 — StarDome コンテナ機器を含む。StarDome 1 より密度が高い：一目の当直ではなく管理者向け。",
    demoNotice:
    ...
    heartbeatOk: "到達可能",
    heartbeatFail: "到達不能",
    helmReady: "Pilot API 設定済み",
    helmMissing: "Pilot API キー未設定",
    equipmentTitle: "機器監視",
    colEquipment: "機器",
    colStatus: "状態",
    colCheck: "最終自己診断",
    ...
    blackboxLead:
      "このブラウザのセッション記録 — Pilot の会話とシナリオ実行 — は StarDome 1 に書かれ、ローカルに保持されます。",
    blackboxLeadLive: "この展開の記録はまだありません。",
    blackboxEmpty: "記録はまだありません。",
    blackboxOpen: "StarDome 1 の記録器を開く →",
    conversation: "会話",
    scenarioRun: "シナリオ",
    ...
    testFail: "フィードなし",
    auditTitle: "監査ログ",
    auditLead: "管理操作 — StarDome 1 のイベントログとは別です。",
    ...
    notifyNote:
      "このデモは経路表だけを保存します。メール、SMS、通話、メッセンジャーはこのアイデアプレビューから送られません。",
  ...
  auth: {
    ...
    lead:
      "これはアイデアのデモです。demo / demo でサインインします。データベースがある場合、新規は Operator です。",
    leadLive:
      "LIVE でも同じデモアカウントです。センサーは未接続。管理はこのセッションを使います。",
    nameLabel: "名前",
    emailLabel: "メールまたは demo",
    roleLabel: "役割",
    namePlaceholder: "お名前",
    ...
    sessionNotice:
      "StarDome 1 と Backend のサインインセッション。書き込みで役割を確認します。",
    sessionNoticeLive:
    ...
    passwordLabel: "パスワード",
    forgotLink: "パスワードを忘れましたか？",
    signingIn: "サインイン中…",
    credentialsError: "この認証情報は認識されませんでした。",
    enterCredentials: "メールとパスワードを入力してください。",
    demoHint:
      "これはアイデアのデモです。demo / demo でサインインします。固有のパスワードはここに出しません。",
    noAccount: "アカウントがありませんか？",
    hasAccount: "すでにアカウントがありますか？",
    signUpLink: "登録",
    signUpTitle: "StarWall アカウントを作成",
    organizationOptional: "組織（任意）",
    confirmPassword: "パスワードの確認",
    creatingAccount: "アカウントを作成中…",
    signUpAction: "登録",
    forgotTitle: "パスワードをリセット",
    forgotSent: "メールは送っていません。demo / demo でデモを開いてください。",
    forgotSubmit: "続ける",
    forgotLead:
      "このアイデアデモはリセットメールを送りません。demo / demo でサインインしてください。",
    ...
    signupThenLogin: "アカウントを作成しました。ログインページから入ってください。",
    googleHostError: "このホストではサインインを完了できませんでした。メールとパスワードを試してください。",
    bodies: {
      health: "サービスの心拍、回線、バックアップ経路。",
      equipment: "接続機器の診断と自己点検。",
      access: "役割階層。Super Admin がユーザーを管理します。",
      blackbox: "このブラウザに残る StarDome 1 セッション記録。",
      integrations: "フィード登録 — レーダー、AIS、カメラ、satcom。",
      audit: "管理操作。StarDome 1 のイベントログとは別です。",
      overview: "公開サイトの概要と入口カード。",
      how: "つなぐ、理解する、決める — 構成と能力。",
      bridge: "StarDome 1 — 状況図とシナリオ。",
      connections: "コア、センサー、StarDome 1、Support Center の地図。",
      ...
      containers: "StarWall を動かす StarDome の展開用コンテナ機器。",
      about: "誰が StarWall を作り、何を守り、導入をどう話すか。",
      contact: "StarDome Maritime への説明依頼。",
    },
  },
  home: {
    kicker: "StarWall, StarDome",
    title: "当直は人の仕事です。画面同士が言い争う必要はありません。",
    lead: "ヨットでもマリーナでも、レーダーとカメラはたいてい既にあります。問題は時計が違うことです。StarWall は既に払った装備を読み、一つの StarDome 1 に置きます。次に自分が取る手を言います。取るかどうかは当直です。",
    points: [
      "既設の装備で動作します — 入れ替えは不要です",
      "船舶やサイトを学習し、稼働が長いほど精度が上がります",
      "必要なときは StarDome の Security Support Center に直接つながります",
    ],
    contactCta: "StarDome Maritime に問い合わせる",
    pdfCta: "概要をダウンロード（PDF）",
    cards: [
      { title: "仕組み", body: "接続、理解、判断 — 三つの手順" },
      { title: "実際の動きを見る", body: "StarDome 1 インターフェースのインタラクティブな確認" },
      { title: "レベル", body: "必須の監視から完全な個別構築まで" },
      { title: "装備", body: "何に、どのように接続するか" },
    ],
    interfaceKicker: "StarDome 1",
    interfaceTitle: "StarDome 1 に今あるもの",
    interfaceLead:
    ...
    containersLink: "StarWall は StarDome の展開可能なコンテナハードウェアでも稼働します →",
  },
  how: {
    kicker: "仕組み",
    title: "接続、理解、判断",
    ...
    steps: [
      ...
      {
        title: "判断",
        body: "明確で説明可能なリスクレベルと、必要なときは StarDome の Security Support Center への直通回線。",
      },
    ],
    ...
    capabilities: [
      ...
      {
        title: "StarDome の Support Center に接続",
  ...
  walkthrough: {
    ...
    steps: [
      ...
      "StarDome 1 は一つの明確な推奨を示します。VHF ch.16 で呼び出し、当直を強化し、距離が 1.0 NM を下回れば変針の準備。",
  ...
  bridge: {
    ...
    simulate: "警報を模擬",
    resolve: "解消してリセット",
    disclaimer: "© StarDome Inc. · StarWall — デモインターフェース、説明用データ、実船ではありません。",
    risks: ["平常", "注意", "上昇", "重大"],
    systems: [
      "レーダー",
      "AIS",
  ...
  levels: {
    ...
    honestySr: "現在提供中と開発中",
    mapNote:
      "これらのレベルは StarDome Maritime の現行サービス構成に対応します。LIGHT と ADVANCED は Protect に、INTELLIGENCE と CUSTOM は Intelligence + Support に広がります。",
  ...
  pricing: {
    kicker: "料金",
    title: "配備を構成する",
    lead: "対象、StarWall ティア、StarDome Container ハードウェア、追加装備を選びます。右側の見積もりは構成に合わせて更新され、月額ソフトウェアと一時費用は分けて表示されます。",
    ...
    faq1aBefore:
      "StarDome Security Gateway と、対象への設置です。StarDome Container のハードウェアは別料金です — 参照",
  ...
  contact: {
    ...
    sending: "記録中…",
    success:
      "依頼を記録しました。この展開にメールボックスがある場合のみ、写しが送られます。",
    error: "記録できませんでした。もう一度お試しください。",
    required: "この項目は必須です。",
    invalidEmail: "有効なメールアドレスを入力してください。",
  },
  containers: {
    kicker: "StarDome · 展開可能なセキュリティコンテナ",
    ...
    cmTitle: "対抗手段",
    cmLegal:
      "対抗手段の装備は、選定されたコンテナティアで利用できます。有効化または運用には、常に管轄ごとの認可と免許を持つ操作者が必要です。StarDome Container の探知・分析層（StarWall）がこれらのシステムを自ら起動することはありません — 起動は毎回、認可された操作者による人の判断です。",
    cmItems: [
      {
        name: "迎撃ドローンシステム",
  ...
  about: {
    ...
    teamField:
      "彼らは StarDome のプロフェッショナルであり、実地の条件で大きな実務経験を積んでいます。迷う時間のない臨界の局面で判断してきた人たちです。その経験が StarWall を形づくります。一枚の絵と、次の一手。動く人のためのものです。",
    teamPoints: [
      {
        title: "実地の条件",
