...
export const es: Messages = {
  nav: {
    ...
    faq: "FAQ",
    containers: "Contenedor StarDome",
    about: "Acerca de",
    contact: "Contacto",
    backend: "Backend",
    auth: "Acceso",
  ...
  chrome: {
    rights: "© StarDome Inc. 2026 · Todos los derechos reservados",
    ...
    footerLegal: "Legal",
    footerBlurb:
      "StarWall by StarDome — una sola imagen del equipo que ya tiene y un siguiente paso claro para quien está de guardia.",
  },
  seo: {
    home: "StarWall by StarDome — inteligencia de seguridad marítima",
    howItWorks: "Cómo funciona StarWall — StarWall by StarDome",
    interface: "StarDome 1 — demostración interactiva — StarWall by StarDome",
    levels: "Niveles de suscripción — StarWall by StarDome",
    pricing: "Planes — StarWall by StarDome",
    technology: "Equipos e integración — StarWall by StarDome",
    faq: "FAQ — StarWall by StarDome",
    containers: "Contenedores — StarDome",
    containersDetection: "Conjunto de detección — StarDome Containers",
    containersSpecs: "Especificaciones — StarDome Containers",
    ...
    about: "Por qué StarWall — StarWall by StarDome",
    contact: "Contacto — StarWall by StarDome",
    backend: "StarWall Backend — administración del sistema — StarWall by StarDome",
    connections: "Mapa de conexiones — StarWall by StarDome",
    login: "Iniciar sesión — StarWall by StarDome",
    signup: "Crear cuenta — StarWall by StarDome",
    forgotPassword: "Contraseña olvidada — StarWall by StarDome",
    tasks: "Todas las tareas — StarWall by StarDome",
    privacy: "Privacidad — StarWall by StarDome",
    terms: "Términos de servicio — StarWall by StarDome",
  },
  legal: {
    privacyTitle: "Política de privacidad",
    privacyUpdated: "Actualizado: 7 de septiembre de 2026",
    privacyIntro:
      "Esta política explica cómo StarDome Inc. («StarDome», «nosotros») trata la información cuando usa el sitio StarWall, StarDome 1 ilustrativo, Pilot y las pantallas de administración. Describe el producto tal como existe hoy, incluidos DEMO y LIVE.",
    privacySections: [
      ...
      { title: "Acceso y cesión", body: "El acceso sigue los roles de Backend: Super Admin, Admin, Operator y Viewer. El alojamiento y la base tratan datos bajo nuestras instrucciones cuando hay despliegue conectado. Anthropic recibe el mensaje que envía a Pilot para que el asesor responda, no para marketing de StarDome." },
    ...
    termsIntro:
      "Estos términos rigen el sitio StarWall y las pantallas ilustrativas de StarDome 1, Pilot y Backend. El uso operativo de StarWall en un buque o emplazamiento exige un acuerdo escrito aparte con StarDome.",
    termsSections: [
      { title: "Aceptación", body: "Al usar este sitio acepta estos términos. StarDome puede actualizarlos; rige la fecha al inicio de la página." },
      { title: "StarDome 1 ilustrativo", body: "DEMO es un cuadro de formación. No es un feed de sensores. LIVE muestra el despliegue real: si no hay equipo, el cuadro está vacío. Las acciones recomendadas y las respuestas de Pilot son consejo para quien está de guardia. No sustituyen su juicio." },
      ...
      { title: "Propiedad, responsabilidad, contacto", body: "StarWall, StarDome y el logotipo son marcas de StarDome. El contenido se ofrece «tal cual». StarDome no responde de decisiones tomadas solo a partir de la demo pública o de Pilot en este sitio. Preguntas: /contact o star-wall.com." },
    ],
  },
  surface: {
    ...
    connectionsOut: "Información de salida (núcleo → StarDome 1 / Support)",
    connectionsOff: "Sin conexión",
    helmTitle: "Pilot",
    helmAdvisor: "ASESOR DE GUARDIA",
    helmAsk: "Preguntar a Pilot…",
    helmSend: "Enviar",
    helmHide: "Ocultar",
    helmOpen: "Abrir Pilot",
    helmEmpty:
      "Pilot está de guardia. Pregunte por StarWall, StarDome 1, los planes o los contenedores StarDome — voz o texto. Solo consejo; usted decide.",
  ...
  backend: {
    ...
    lead:
      "Conectividad, salud del equipo, control de acceso y supervisión — incluido el hardware de contenedores StarDome. Más denso que StarDome 1: para administradores, no para una mirada rápida.",
    demoNotice:
    ...
    helmReady: "API de Pilot configurada",
    helmMissing: "Clave API de Pilot no definida",
    ...
    blackboxLead:
      "Registros de esta sesión en el navegador — conversaciones de Pilot y escenarios — escritos en StarDome 1 y retenidos en local.",
    blackboxLeadLive: "Aún no hay registros de este despliegue.",
    blackboxEmpty: "Aún no hay registros.",
    blackboxOpen: "Abrir el registrador en StarDome 1 →",
    ...
    auditLead: "Acciones administrativas — distintas del registro de eventos de StarDome 1.",
  ...
  auth: {
    ...
    lead:
      "Esta es una demostración de idea. Entre con demo / demo. Las cuentas nuevas empiezan como Operator si hay base de datos.",
    leadLive:
      "Las mismas cuentas de demostración en LIVE. Aún no hay sensores; la administración usa esta sesión.",
    nameLabel: "Nombre",
    emailLabel: "Email o demo",
    roleLabel: "Rol",
    ...
    demoAccounts: "Demostración de idea",
    liveEmptyAccounts: "Aún no hay cuentas en este despliegue.",
    sessionNotice:
      "Sesión de acceso para StarDome 1 y Backend. Los roles se aplican en las escrituras.",
    sessionNoticeLive:
      "Las mismas cuentas que en DEMO. LIVE sigue sin sensores.",
    ...
    forgotLink: "¿Olvidó la contraseña?",
    signingIn: "Entrando…",
    credentialsError: "Esas credenciales no se reconocieron.",
    enterCredentials: "Escriba su email y contraseña.",
    demoHint:
      "Esta es una demostración de idea. Entre con demo / demo. Aquí no se publican contraseñas únicas.",
    noAccount: "¿No tiene cuenta?",
    hasAccount: "¿Ya tiene cuenta?",
    signUpLink: "Registrarse",
    signUpTitle: "Crear una cuenta StarWall",
    organizationOptional: "Organización (opcional)",
    confirmPassword: "Confirmar contraseña",
    creatingAccount: "Creando cuenta…",
    signUpAction: "Registrarse",
    forgotTitle: "Restablecer contraseña",
    forgotSent: "No se envió correo. Use demo / demo para abrir el recorrido.",
    forgotSubmit: "Continuar",
    forgotLead:
      "Esta demostración de idea no envía correo de restablecimiento. Entre con demo / demo.",
    backToSignIn: "← Volver a entrar",
    orDivider: "o",
    enterName: "Escriba su nombre.",
    enterValidEmail: "Escriba un email válido.",
    passwordShort: "La contraseña debe tener al menos 8 caracteres.",
    passwordMismatch: "Las contraseñas no coinciden.",
    signupFailed: "No se pudo crear la cuenta.",
    signupThenLogin: "Cuenta creada. Entre desde la página de acceso.",
    googleHostError: "El acceso no pudo terminar en este host. Pruebe email y contraseña.",
    bodies: {
      ...
      blackbox: "Registros de sesión de StarDome 1 guardados en este navegador.",
      integrations: "Registro de flujos — radar, AIS, cámaras, satcom.",
      audit: "Acciones administrativas, distintas del registro de eventos de StarDome 1.",
      overview: "Resumen y tarjetas de entrada del sitio público.",
      how: "Conectar, comprender, decidir — arquitectura y capacidades.",
      bridge: "StarDome 1 — imagen situacional y escenarios.",
      connections: "Mapa del núcleo, sensores, StarDome 1 y Support Center.",
      ...
      containers: "Hardware de contenedor StarDome desplegable que ejecuta StarWall.",
      about: "Quién construye StarWall, qué defendemos y cómo hablar de un despliegue.",
      contact: "Solicitar una reunión con StarDome Maritime.",
    },
  },
  home: {
    kicker: "StarWall, StarDome",
    title: "La guardia la lleva una persona. Las pantallas no deberían discutir entre ellas.",
    lead: "En el yate, la marina, el puerto o la isla el radar y las cámaras casi siempre ya están. El lío es que no comparten reloj. StarWall lee lo que ya pagó y lo pone en un StarDome 1. Luego dice qué haría. Usted lo toma o no.",
    points: [
      ...
      "Se conecta de inmediato al Security Support Center de StarDome cuando importa",
    ],
    contactCta: "Contactar con StarDome Maritime",
    pdfCta: "Descargar resumen (PDF)",
    cards: [
      { title: "Cómo funciona", body: "Conectar, comprender, decidir — en tres pasos" },
      { title: "Véalo en acción", body: "Una mirada interactiva a la interfaz StarDome 1" },
    ...
    interfaceTitle: "Qué hay hoy en StarDome 1",
    interfaceLead:
    ...
    containersLink: "StarWall también funciona dentro del equipo de contenedor desplegable de StarDome →",
  },
  how: {
    ...
    steps: [
      ...
      {
        title: "Decidir",
        body: "Un nivel de riesgo claro y explicable y, cuando hace falta, una línea directa al Security Support Center de StarDome.",
      },
    ],
    ...
    capabilities: [
      ...
      {
        title: "Conectado al Support Center de StarDome",
  ...
  walkthrough: {
    ...
    steps: [
      ...
      "StarDome 1 muestra una recomendación clara: llamar por VHF ch.16, reforzar la guardia y estar listo para alterar el rumbo si la distancia baja de 1.0 NM.",
  ...
  bridge: {
    ...
    disclaimer: "© StarDome Inc. · StarWall — interfaz de demostración, datos ilustrativos, no es un buque en vivo.",
    risks: ["Normal", "Atención", "Elevado", "Crítico"],
    systems: [
      "Radar",
      "AIS",
      "CCTV · 6 cámaras",
  ...
  levels: {
    ...
    mapNote:
      "Estos niveles se corresponden con la estructura de servicio actual de StarDome Maritime: LIGHT y ADVANCED encajan en Protect; INTELLIGENCE y CUSTOM se extienden a Intelligence + Support.",
  ...
  pricing: {
    ...
    lead: "Elija el objeto, el nivel StarWall, el hardware StarDome Container y los extras. La estimación de la derecha se actualiza al configurar — el software mensual y el equipo de pago único se mantienen separados.",
    ...
    getStarted: "Empezar",
    contactAgron: "Contactar con StarDome",
    disclaimer:
      "Nada en esta página es un presupuesto. La cifra la da la persona que redactará el contrato.",
    salesNote:
      "Los nombres de los planes y lo que incluyen son públicos. La cifra no está en el sitio. La da el comercial que llevará el contrato.",
    askSales: "Escribir a quien lleva el contrato",
    faqTitle: "Preguntas sobre los planes",
    faq1q: "¿Qué incluye el coste único del equipo?",
    faq1aBefore:
      "El StarDome Security Gateway y la instalación en su objeto. El hardware StarDome Container se cotiza por separado — consulte",
    ...
    config: {
      ...
      stepContainer: "Hardware StarDome Container",
      ...
      customQuote: "Contacte con StarDome para un presupuesto a medida",
      ...
      hideSummary: "Ocultar",
      quoteMessage:
        "Me interesa: {summary}. Pido que la persona que lleve el contrato envíe el precio.",
      objects: {
        yacht: {
  ...
  contact: {
    ...
    sending: "Registrando…",
    success:
      "Solicitud registrada. Se envía copia por correo solo si este despliegue tiene un buzón configurado.",
    error: "No se pudo registrar la solicitud. Inténtelo de nuevo.",
    required: "Este campo es obligatorio.",
    invalidEmail: "Introduzca un correo válido.",
  },
  containers: {
    kicker: "StarDome · CONTENEDOR DE SEGURIDAD DESPLEGABLE",
    ...
    contact: "Contactar con StarDome",
    ...
    cmLegal:
      "El equipo de contramedidas está disponible en niveles de contenedor seleccionados. Activarlo u operarlo exige siempre autorización propia de la jurisdicción y un operador con licencia. La capa de detección y análisis de StarDome Container (StarWall) nunca activa estos sistemas por sí misma — la activación es siempre una decisión humana, tomada por un operador autorizado, cada vez.",
    cmItems: [
      {
  ...
  about: {
    ...
    teamField:
      "Son profesionales de StarDome con una amplia experiencia práctica en condiciones reales. Han trabajado en situaciones críticas donde hay que decidir rápido — sin ambigüedad y sin tiempo que perder. Esa experiencia define StarWall: una imagen y un siguiente paso para quien debe actuar.",
    teamPoints: [
      {
    ...
    contactCta: "Contactar con StarDome",
  },
};
