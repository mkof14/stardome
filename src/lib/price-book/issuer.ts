/** Letterhead used on the closed desk and on customer PDFs. No invented street. */
export const ISSUER = {
  ...
  caveat:
    "Specialized equipment and any response capability remain under human authorization and the law of the place where they are used.",
} as const;
