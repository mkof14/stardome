export const pageMeta = {
  ...
  technology: {
    title: "Equipment & Integration — StarDome",
    description:
  ...
  login: {
    title: "Sign in — StarDome",
    description: "Sign in to StarDome with email and password or Google.",
  },
  signup: {
    title: "Sign up — StarDome",
    description: "Create a StarDome account with email and password or Google.",
  },
  forgotPassword: {
    title: "Forgot password — StarDome",
    description: "Request a StarDome password reset link.",
  },
  tasks: {
    title: "All tasks — StarDome",
    description:
      "Every administration surface and site workstream, listed as openable tasks.",
  },
  privacy: {
    title: "Privacy — StarDome",
    description:
      "What StarWall stores, where records are kept, and who can access them.",
  },
  terms: {
    title: "Terms of Service — StarDome",
    description: "Terms for using StarDome 1, Backend, and Pilot.",
  },
} as const;
